...
export const useAuthStore = defineStore('auth', () => {
  ...
  return { token, usuario, loading, error, isAuthenticated, rol, isProductor, isSupervisor, isBodeguero, isResponsable, isAdmin, canCapture, login, registro, logout, clearError }
})
