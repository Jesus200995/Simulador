  ...
  <div class="shell">
    ...
    <header class="topbar">
      ...
      <nav class="topbar-nav">
        <router-link v-if="!authStore.isAdmin" to="/" exact class="nav-pill">
        ...
        <router-link v-if="!authStore.isBodeguero && !authStore.isAdmin" to="/seguimiento" class="nav-pill">
    ...
    <nav class="bottom-tabs">
      <!-- Inicio: solo para no-admin -->
      <router-link v-if="!authStore.isAdmin" to="/" exact class="tab-item">
      ...
      <!-- Admin: Dashboard + Productores + Administración -->
      <template v-if="authStore.isAdmin">
        ...
        <router-link to="/admin" class="tab-item">
          <div class="tab-icon-wrap">
      ...
      <div v-if="moreOpen" class="more-overlay" @click.self="moreOpen = false">
        <div class="more-panel">
          ...
          <div class="more-links">
            ...
            <router-link v-if="authStore.isAdmin" to="/admin/dashboard" class="more-link" @click="moreOpen = false">
