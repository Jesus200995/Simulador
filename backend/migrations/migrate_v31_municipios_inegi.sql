-- Migración V31: Catálogo completo de municipios INEGI
-- Fuente: AGEEML (Catálogo Único de Claves de Áreas Geoestadísticas)
-- INEGI 2026 — 2,478 municipios, 32 estados
-- Generado automáticamente desde el catálogo oficial

-- Limpiar municipios anteriores (cargados manualmente/parcialmente)
-- y reemplazar con el catálogo INEGI completo
DELETE FROM geo_municipality WHERE TRUE;

INSERT INTO geo_municipality (municipality_id, state_id, name) VALUES
...
('07015', '07', 'Cacahoatán'),
('07016', '07', 'Catazajá'),
('07017', '07', 'Cintalapa de Figueroa'),
('07018', '07', 'Coapilla'),
...
('07120', '07', 'Capitán Luis Ángel Vidal'),
('07121', '07', 'Rincón Chamula San Pedro'),
('07122', '07', 'El Parral'),
('07123', '07', 'Emiliano Zapata'),
('07124', '07', 'Mezcalapa'),
('07125', '07', 'Honduras de la Sierra'),
('08001', '08', 'Ahumada'),
('08002', '08', 'Aldama'),
('08003', '08', 'Allende'),
...
('08006', '08', 'Bachíniva'),
('08007', '08', 'Balleza'),
('08008', '08', 'Batopilas de Manuel Gómez Morín'),
('08009', '08', 'Bocoyna'),
...
('20059', '20', 'Heroica Ciudad de Miahuatlán de Porfirio Díaz'),
...
-- Verificar resultado
SELECT gs.name AS estado, COUNT(*) AS municipios
FROM geo_municipality gm
JOIN geo_state gs ON gs.state_id = gm.state_id
GROUP BY gs.name
ORDER BY gs.name;