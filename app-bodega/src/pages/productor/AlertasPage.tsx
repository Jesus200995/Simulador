...
export default function AlertasPage() {
  ...
  return (
    <div className="w-full">
      ...
      {/* ── Header con volver ── */}
      <div className="sticky top-0 z-20 w-full bg-gradient-to-br from-[#1e5b4f] via-[#267a6b] to-[#2e8c7b] rounded-b-3xl shadow-[0_4px_20px_rgba(26,92,56,0.2)]">
              ...
              className={`w-full rounded-[1.5rem] border overflow-hidden transition-all duration-300
                ${isOpen
                  ...
                  : n.leida
                    ...
                    : 'bg-emerald-50/40 border-[#1e5b4f]/20 shadow-[0_4px_16px_rgba(26,92,56,0.1)]'}
                ${isOpen ? 'bg-white' : ''}
              `}
            >
              {/* ── Cabecera clickeable ── */}
              ...
              >
                ...
                <div className={`relative w-10 h-10 rounded-[0.875rem] flex items-center justify-center flex-shrink-0 mt-0.5 transition-all duration-300
                  ...
                  {!n.leida && (
                    <span className="absolute -top-0.5 -right-0.5 w-2 h-2 rounded-full bg-[#1e5b4f] ring-2 ring-white animate-pulse" />
                  )}
                </div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-1">
                    ...
                    {!esTx ? (
                      <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300
                        ${isOpen ? 'bg-[#1e5b4f]/10 rotate-180' : 'bg-gray-100'}`}>
                        ...
                        yaInteresado ? (
                          <div className="flex items-center justify-between gap-2 bg-emerald-50 ring-1 ring-emerald-200 rounded-xl px-3.5 py-3">
                            ...
                            <button
                              ...
                              className="flex items-center gap-1 text-[12px] font-bold text-[#1e5b4f] hover:underline"
                            >
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <button
                              ...
                              className="flex items-center justify-center gap-1.5 rounded-xl py-2.5 text-[13px] font-bold bg-[#1e5b4f] text-white shadow-[0_4px_14px_rgba(26,92,56,0.3)] hover:bg-[#16512f] active:scale-[0.97] transition-all duration-200 disabled:opacity-60"
                            >
                              {enviandoEste
      ...
      {toast && (
        <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[2000] w-[calc(100%-2rem)] max-w-xs">
          <div className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl shadow-2xl backdrop-blur-md
            ${toast.ok ? 'bg-[#1e5b4f] text-white' : 'bg-red-600 text-white'}`}>
