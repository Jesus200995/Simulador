    ...
    <div className="bg-[#F2F2F7]">
      <div className="w-full bg-gradient-to-br from-[#1A5C38] via-[#1e6b42] to-[#22733f] rounded-b-3xl shadow-[0_4px_20px_rgba(26,92,56,0.25)]">
        <div className="max-w-5xl mx-auto px-4 sm:px-5 pt-4 pb-5">
          <p className="text-[9.5px] font-semibold text-green-300/70 uppercase tracking-widest mb-2">Apoyos</p>
          <h1 className="text-[19px] sm:text-[9.5px] font-black text-white leading-tight tracking-tight">Apoyos disponibles</h1>
          <p className="text-[9.5px] font-medium text-white/40 mt-0.5">Programas del gobierno para productores</p>
        </div>
      </div>

      <div className="max-w-lg mx-auto px-4 sm:px-5 pt-5 pb-6">
        ...
        <div className="border-t border-zinc-200 pt-5">
          ...
          <div className="bg-white ring-1 ring-zinc-100 rounded-2xl p-4">
            <div className="flex items-start gap-3">
              <Warehouse size={12} className="text-zinc-400 shrink-0 mt-0.5" />
              <div>
                ...
                <button onClick={() => navigate('/productor/mapa')}
                  ...
                  Ver bodegas con servicios <ChevronRight size={12} />
                </button>
              </div>
            </div>
          </div>
