...
export default function DashboardProductorPage() {
    ...
    return (
      <div className="absolute inset-0 flex flex-col bg-[#e8f5f3] overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute top-0 left-0 right-0 h-[40%] bg-gradient-to-b from-[#002f2a]/10 to-transparent"></div>
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-6">
          <div className="w-full max-w-[340px] animate-in fade-in zoom-in-95 slide-in-from-bottom-8 duration-700 ease-out">
            <div className="bg-white/95 backdrop-blur-2xl rounded-[32px] p-8 shadow-[0_20px_60px_-15px_rgba(26,92,56,0.15)] border border-white relative overflow-hidden text-center group">
              <div className="absolute inset-0 bg-gradient-to-br from-[#002f2a]/[0.02] to-transparent pointer-events-none"></div>
              
              <div className="w-16 h-16 bg-gradient-to-br from-[#002f2a] to-[#124227] rounded-[20px] flex items-center justify-center mx-auto mb-6 shadow-[0_8px_25px_-5px_rgba(26,92,56,0.4)] transform group-hover:scale-105 transition-transform duration-500">
              ...
              <button onClick={() => navigate('/productor/ciclo')}
                className="w-full bg-[#002f2a] hover:bg-[#124227] text-white py-3.5 rounded-full font-bold text-[15px] shadow-[0_6px_15px_rgba(26,92,56,0.2)] active:scale-[0.98] transition-all duration-200">
                Registrar ciclo
              </button>
            </div>
          </div>
  ...
  return (
    <div className="bg-[#e8f5f3]">
      ...
      <div className="sticky top-0 z-20 w-full bg-gradient-to-br from-[#002f2a] via-[#267a6b] to-[#2e8c7b] rounded-b-3xl shadow-[0_4px_20px_rgba(26,92,56,0.25)] relative overflow-hidden">
        <BannerCanvas />
        <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-4 pb-5 relative z-10">
          ...
          <div className="flex items-center gap-2 mt-3 flex-wrap">
            ...
            <div className="ml-auto bg-[#002f2a]/20 border border-[#002f2a]/30 backdrop-blur-sm rounded-full px-3 py-1 flex items-center gap-1.5">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-5">
        ...
        <div className="relative overflow-hidden bg-white/95 backdrop-blur-2xl rounded-[1.5rem] p-6 sm:p-8 shadow-[0_2px_10px_rgba(0,0,0,0.02)] hover:shadow-[0_12px_30px_rgba(0,0,0,0.06)] border border-black/[0.04] group transition-all duration-500">
          ...
          <div className="relative z-10">
            ...
            <button 
              ...
              className="mt-5 inline-flex items-center gap-1.5 px-4 py-2 bg-[#002f2a]/10 text-[#002f2a] text-[13px] font-bold rounded-xl active:scale-95 transition-all duration-300 hover:bg-[#002f2a] hover:text-white group/btn"
            >
        ...
        <div className="mt-5">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 mt-0.5">
                        ...
                        {b.is_ventanilla && (
                          <span className="ml-2 bg-emerald-50 text-[#002f2a] text-xs px-2 py-0.5 rounded-full font-medium">
                            Ventanilla
                          </span>
                        )}
                      </p>
          ...
          <button onClick={() => navigate('/productor/mapa')}
            className="w-full mt-3 py-3 text-[#002f2a] text-sm font-semibold
                       ring-2 ring-[#002f2a] rounded-2xl hover:bg-emerald-50 active:scale-[0.98] transition-all duration-200">
            Ver mapa completo
          </button>
        </div>
        ...
        <div className="mt-5">
          <button
            ...
            className={`w-full py-5 rounded-2xl text-white text-lg font-semibold
              ...
              ${isPendiente ? 'bg-zinc-300 cursor-not-allowed'
                : 'bg-[#002f2a] hover:bg-[#1e5b4f] active:scale-[0.97] shadow-lg shadow-green-900/20'}`}
          >
            <Wheat size={24} />
            Propuesta de venta
          </button>
          {!isPendiente && (
            <button
              ...
              className="w-full border-2 border-dashed border-[#002f2a] text-[#002f2a] py-3 rounded-2xl text-sm font-medium
        ...
        {ciclo === null && !dismissedCiclo && !isPendiente && (
          <div className="mt-4 bg-emerald-50 ring-2 ring-[#002f2a]/20 rounded-2xl p-4">
            <p className="text-[#002f2a] text-sm font-bold flex items-center gap-1.5">
            ...
            <div className="flex gap-2 mt-3">
              <button onClick={() => navigate('/productor/ciclo')}
                className="flex-1 bg-[#002f2a] hover:bg-[#1e5b4f] text-white text-sm py-2.5 rounded-xl font-semibold transition-colors">
                Registrar ciclo
              </button>
              <button onClick={() => { localStorage.setItem('dismiss_ciclo', '1'); setDismissedCiclo(true); }}
                className="px-4 text-[#002f2a] text-sm hover:underline">
                Despues
              </button>
            </div>
          </div>
