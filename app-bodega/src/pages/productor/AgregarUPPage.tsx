      ...
      {paso === 'info' && (
        <div className="p-4 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none border border-gray-200 rounded-xl px-4 py-3 pr-10 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#002f2a]"
                >
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  disabled={!estadoId}
                  className="w-full appearance-none border border-gray-200 rounded-xl px-4 py-3 pr-10 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#002f2a] disabled:bg-[#f4fbf7] disabled:text-gray-400"
                >
          ...
          <button onClick={() => setPaso('mapa')} disabled={!estadoUp || !municipioUp}
            className="w-full bg-[#002f2a] text-white py-4 rounded-2xl font-semibold disabled:opacity-40">
