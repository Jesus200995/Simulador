  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="flex items-center px-4 py-3 border-b bg-white">
        ...
        <h1 className="flex-1 text-center font-semibold text-gray-800">Marca tu parcela</h1>
        <div className="w-8" />
      </div>

      <div className="px-4 py-3 bg-white">
        <p className="text-sm text-gray-500">
          Toca el mapa donde está tu terreno. Puedes buscar con la lupa.
        </p>
      </div>
      ...
      <div className="px-4 py-4 bg-white border-t space-y-2">
        <button onClick={guardar} disabled={!coords || loading}
          ...
          {loading ? 'Guardando...' : coords ? 'Confirmar ubicación' : 'Toca el mapa para marcar'}
        </button>
