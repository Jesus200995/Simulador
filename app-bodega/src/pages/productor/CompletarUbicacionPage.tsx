...
export default function CompletarUbicacionPage() {
  ...
  return (
    <div
      className="fixed inset-0 flex flex-col bg-[#000e0c] z-[2000]"
            ...
            {pointCount > 0 && (
              <div className="flex gap-2">
                ...
                <button onClick={() => dibujarRef.current?.finishDraw()} disabled={!puedeTerminar}
                  className="flex-[1.4] flex items-center justify-center gap-1.5 bg-white text-[#002f2a] py-3 rounded-xl text-sm font-bold disabled:opacity-30 active:scale-[0.97] transition-all">
        ...
        {drawMode === 'idle' && poligono && (
          <div className="max-w-md mx-auto space-y-3">
            ...
            <button onClick={guardar} disabled={loading}
              className="w-full bg-white text-[#002f2a] py-4 rounded-2xl text-base font-bold disabled:opacity-40 active:scale-[0.98] transition-all flex items-center justify-center gap-2">
