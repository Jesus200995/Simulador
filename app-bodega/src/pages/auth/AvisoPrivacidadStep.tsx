...
export default function AvisoPrivacidadStep({
  ...
  return (
    <div
      className="h-[100dvh] flex flex-col bg-gradient-to-b from-[#020e0c] via-[#000e0c] to-[#002f2a]"
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="px-5 py-4 border-t border-white/10 bg-black/20 backdrop-blur-md">
            <button
              ...
              className="w-full bg-white hover:bg-white/90 active:scale-[0.98] text-[#002f2a] rounded-xl py-3.5 font-bold flex items-center justify-center gap-2 transition-all shadow-xl shadow-black/30"
            >
          ...
          <div className="px-5 py-5 space-y-4">
              ...
              {(camStatus === 'idle' || camStatus === 'error') && (
                <div className="px-4 pb-4">
                  <div className="relative overflow-hidden rounded-xl">
                    {/* Botón visual */}
                    <div className="w-full bg-white text-[#002f2a] py-4 rounded-xl font-bold text-[15px] flex items-center justify-center gap-2 shadow-lg select-none pointer-events-none">
                      <Camera size={19} />
            ...
            <div className="pt-1 pb-6">
              <button
                ...
                className="w-full bg-white hover:bg-white/90 active:scale-[0.98] text-[#002f2a] rounded-xl py-4 font-bold flex items-center justify-center gap-2 transition-all shadow-xl shadow-black/30 disabled:opacity-30 disabled:cursor-not-allowed text-[15px]"
              >
                {aceptando
