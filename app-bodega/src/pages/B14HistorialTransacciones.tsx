          ...
          {txs.map(tx => (
            <div key={tx.id}
              ...
              <div className="flex justify-between items-start gap-3 mb-2">
                <p className="font-bold text-[15px] text-gray-900 group-hover/card:text-[#002f2a] transition-colors leading-snug flex-1">
              ...
              <p className="text-[18px] font-black text-[#002f2a] mt-2">
