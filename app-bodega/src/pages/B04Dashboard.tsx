...
export default function B04Dashboard() {
  ...
  const barColor = ocupPct < 70 ? 'bg-[#002f2a]' : ocupPct < 90 ? 'bg-amber-400' : 'bg-red-500';
  const kpiColor = ocupPct < 70 ? 'green' : ocupPct < 90 ? 'yellow' : 'red';

  const acciones = [
    { icon: Tag,        label: 'Publicar precio del día',   path: '/precio-diario',       desc: 'Precio que ofreces hoy',        iconColor: 'text-[#002f2a]',  bg: 'bg-[#002f2a]/[0.08]' },
  ...
  return (
    <div className="w-full">
      {/* ── Banner full-bleed ── */}
      <div className="sticky top-0 z-20 w-full bg-gradient-to-br from-[#002f2a] via-[#267a6b] to-[#2e8c7b] rounded-b-[2rem] shadow-[0_8px_30px_rgba(26,92,56,0.25)] relative overflow-hidden group/banner">
