      ...
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-5">
          ...
          <div className={cardClass}>
            <p className="text-[12px] font-bold text-gray-400 uppercase tracking-widest transition-colors group-hover/card:text-[#002f2a]/60">Bodega y tipo de maíz</p>
            <div>
          ...
          {/* Precio destacado */}
          <div className={cardClass}>
            <p className="text-[12px] font-bold text-gray-400 uppercase tracking-widest transition-colors group-hover/card:text-[#002f2a]/60">Precio</p>
            <div>
              ...
              <input
                ...
                step="1"
                placeholder="6200"
                className="w-full bg-[#e8f5f3] rounded-[1rem] px-4 py-4 text-[28px] font-bold outline-none transition-all duration-300 focus:ring-2 focus:ring-[#002f2a]/40 focus:bg-white border-2 border-transparent focus:border-[#002f2a]/10 text-[#002f2a]"
              />
            </div>
            <div>
        ...
        {historialPrecios.length > 1 && (
          <div className="max-w-4xl mx-auto pb-8 mt-5">
            <div className="bg-white rounded-[1.5rem] border border-black/[0.04] shadow-[0_2px_8px_rgba(0,0,0,0.02)] p-6 transition-all duration-500 hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] hover:-translate-y-0.5">
              <p className="text-[12px] font-bold text-gray-400 uppercase tracking-widest mb-6 transition-colors hover:text-[#002f2a]/60">Historial de precios — últimos 30 días</p>
              <ResponsiveContainer width="100%" height={180}>
                <LineChart data={historialPrecios} margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
                  ...
                  <Line type="monotone" dataKey="precio" stroke="#002f2a" strokeWidth={3} dot={{ r: 4, fill: '#002f2a', strokeWidth: 2, stroke: 'white' }} activeDot={{ r: 6, strokeWidth: 0 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
